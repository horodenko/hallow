...
- [~] Tree(s) — 2 delivered in the asset zip, **but NOT in the repo (flagged 2026-07-06)** — `assets/objects/trees/` doesn't exist; only the 3 bushes are committed. FABLE_KICKOFF.md's "Trees — 2, in assets/objects/trees" is currently untrue. Needs the files committed before the intro map's tree framing can be built.
